...
public class MethodTest
{
    ...
    {
        var method = new Method();
        var param = new ValueType(Guid.NewGuid(), "int");
    ...
    {
        var method = new Method();
        var localVar = new ValueType(Guid.NewGuid(), "int");
    ...
    {
        var localVariable = new ValueType(Guid.NewGuid(), "int");
    ...
    {
        var parameter = new ValueType(Guid.NewGuid(), "int");
